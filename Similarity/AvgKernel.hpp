//  AvgKernel class, part of the SPARE library.
...
/** @brief File AvgKernel.hpp, that contains AvgKernel class.
 *
 * Contains the declaration of the AvgKernel class.
 *
 * @file AvgKernel.hpp
 * @author Lorenzo Livi
 */

#ifndef AVGKERNEL_HPP_
#define AVGKERNEL_HPP_

namespace spare {

/** @brief Average-based Kernel Function.
 *
 * This class implements the @a Similarity concept.
 * This class contains static functions for the computation of the average between the evaluations of three valid kernel functions.
 * The class of kernel functions are closed under the product and addition operators.
...
template <class Kernel1, class Kernel2, class Kernel3>
template <typename SequenceContainer1, typename SequenceContainer2, typename SequenceContainer3>
spare::RealType AvgKernel<Kernel1, Kernel2, Kernel3>::Sim(const SequenceContainer1& c11, const SequenceContainer1& c12,
        const SequenceContainer2& c21, const SequenceContainer2& c22,
        const SequenceContainer3& c31, const SequenceContainer3& c32) const
{
    return (k1.Sim(c11, c12)+k2.Sim(c21, c22)+k3.Sim(c31, c32))/3.;
}


}

#endif /* AVGKERNEL_HPP_ */
