//  ExponentialKernel class, part of the SPARE library.
...
/** @brief File ExponentialKernel.hpp, that contains ExponentialKernel class.
 *
 * Contains the declaration of the Exponential Kernel class.
 *
 * @file ExponentialKernel.hpp
 * @author Lorenzo Livi
 */

#ifndef EXPONENTIALKERNEL_H_
#define EXPONENTIALKERNEL_H_
 ...
 * This class contains static functions for the computation of the similarity between two objects by means of the exponential kernel function.
 ...
 *     <td class="indexvalue">Sigma parameter of the exponential kernel.</td>
...
public:
    ...
    {
        return std::exp(-mDiss.Diss(o1, o2)/(2.0*pow(mSigma, 2.0)));
    }
