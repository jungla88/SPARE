...
/** @brief DOT file reader for the StringGraph graph type.
 *
 * @file StringGraphReader.hpp
 * @author Lorenzo Livi
 */


#ifndef STRINGGRAPHREADER_HPP
#define STRINGGRAPHREADER_HPP
...
// SPARE INCLUDES
#include <spare/Graph/Graph/StringGraph.hpp>
...
/** @brief DOT file reader for string-based labeled graphs.
 */
...
public:
     ...
     * @param[out] g A compatible boost graph defined as a labeled graph with std::string-valued labels
     */
    void read(std::ifstream& in, StringGraph& g) const;
     ...
     * @param[out] g A compatible boost graph defined as a labeled graph with std::string-valued labels
     */
    void read(std::string& in, StringGraph& g) const;
};


void StringGraphReader::read(std::ifstream& in, StringGraph& g) const
{
...
void StringGraphReader::read(std::string& in, StringGraph& g) const
{
