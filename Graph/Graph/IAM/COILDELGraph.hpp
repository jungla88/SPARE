//  COILDELGraph, part of the SPARE library.
...
/** @brief File COILDELGraph.hpp,
 *
 * Contains the declaration of the IAM COILDELGraph type.
 *
 * @file COILDELGraph.hpp
 * @author Lorenzo Livi
 */

#ifndef COILDELGRAPH_HPP
#define COILDELGRAPH_HPP
